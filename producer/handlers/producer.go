...
func (p *KafkaProducer) CreateKafkaTopic() error {
	...
	if err != nil {
		log.Fatal("Error reading Kafka partitions")
		return err
	}
	...
	if err != nil {
		log.Fatal("Error creating Kafka controller")
		return err
	}
	...
	if err != nil {
		log.Fatal("Error connecting to Kafka controller")
		return err
	}
...
func (p *KafkaProducer) ProduceLogKafka(logData data.LogData) error {
	...
	if err != nil {
		log.Fatal("Error marshalling log data")
		return err
	}
